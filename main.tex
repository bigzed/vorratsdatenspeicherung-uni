...
\begin{frame}[allowframebreaks]
  ...
  \bibitem{CCC}
    ...
    \url{http://www.ccc.de/de/vorratsdatenspeicherung }, 05 05 2014
  \bibitem{EUGH}
    Pressemitteilung des Gerichtshofs der Europ"aischen Union,
    \url{http://curia.europa.eu/jcms/upload/docs/application/pdf/2014-04/cp140054de.pdf}, 05 05 2014
  \bibitem{BVerfG}
    Pressemitteilung des Bundesverfassungsgerichts,
    \url{http://www.bverfg.de/entscheidungen/rs20100302_1bvr025608.html}, 05 05 2014
  \bibitem{BVerfG}
    Pressemitteilung des AK-Vorratsdatenspeicherung,
    \url{http://www.vorratsdatenspeicherung.de/content/view/342/79/lang,de/}, 05 05 2014
  \end{thebibliography}
\end{frame}
